  ...
  getSuccessResponse = () => {
    ...
    return (
      <SavedVideosContext.Consumer>
        {value => {
          const {saveVideos, unSaveVideos, listOfSavedVideos} = value

          const isSavedInList = listOfSavedVideos.filter(
            eachSavedVideo => eachSavedVideo.id === id,
          )[0]

          console.log('Saved Functionality', {isSavedInList, trueIfSaved})

          const savingHandler = () => {
            if (trueIfSaved || isSavedInList !== undefined) {
          ...
          return (
            <>
              ...
              <ReactionSection
                ...
                trueIfSaved={isSavedInList !== undefined ? true : trueIfSaved}
              />
